...
#let author = "言文 花子"
#let email = "<u0123456x@ecs.osaka-u.ac.jp>"
#let title = "論文のタイトル"
#let subtitle = "論文サブタイトル"
#let venue = "中間発表"
#let affiliation = "大阪大学 大学院人文学研究科 言語文化学専攻 博士前期課程1年次"
#let supervisors = "A准教授 B教授"

#set page(paper: "a4", margin: (x: 2cm, y: 2cm), header: align(center)[#venue], numbering: "1")
#set text(lang: "ja", size: 11pt, font: ("Linux Libertine", "Source Han Serif"))
...
#align(center)[#affiliation #author]
#align(center)[#email]
#align(center)[指導教員：#supervisors]
